    ...
    <>
      <header>
        ...
        <div className="nav-actions">
          <Link className="btn btn-ghost desktop-only" to="/account">Accedi</Link>
      ...
      <div className={`mobile-nav${menuMobileAperto ? ' open' : ''}`}>
        ...
        <Link className="btn btn-primary" to="/account" style={{ textAlign: 'center', marginTop: 10 }} onClick={() => setMenuMobileAperto(false)}>Accedi</Link>
      </div>
